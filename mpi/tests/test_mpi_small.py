    ...
    for num_processes in process_counts:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                # Load results from Results/MPIAnalysis folder
...
def main():
    ...
    # Save test results to Results/MPIAnalysis folder
    os.makedirs('Results/MPIAnalysis', exist_ok=True)
    with open('Results/MPIAnalysis/mpi_small_test_results.json', 'w') as f:
        json.dump(results, f, indent=2)
    
    print(f"\nTest results saved to: Results/MPIAnalysis/mpi_small_test_results.json")
